...
enum FormCues {
    ...
    private static let linesByName: [String: String] = [
        ...
        "Good Morning": "Keep your back flat, soften your knees, and push your hips back until your hamstrings stretch.",
        ...
        "Arnold Press": "Start with palms facing you, rotate as you press, and finish palms forward overhead.",
        ...
        // Quads
        "Squat": "Brace hard, knees out over the toes, sink until your thighs are parallel, drive up through mid foot.",
        ...
        "Bodyweight Squat": "Feet shoulder width, chest tall, sit until your thighs are parallel to the floor, stand tall.",
        ...
        "Nordic Curl": "Lower as slowly as you can, keep your body straight from knees to shoulders, hands ready to catch.",
        ...
        "Machine Hip Thrust": "Set the pad on your hips, drive up until your hips are fully straight, lower with control.",
        ...
        "Donkey Calf Raise": "Hinge over with hips back, stretch deep, rise high onto your toes.",
        ...
        "Side Plank": "Elbow under your shoulder, stack your feet, lift the hips into one straight line.",
        ...
        "Toes to Bar": "Hang tight, press down on the bar with straight arms, and sweep your feet up.",
        ...
        "Thruster": "Squat deep with the bar at your shoulders, then drive it overhead in one motion.",
        ...
        "Axle Clean and Press": "Keep the thick bar close, catch it on your shoulders, then brace and drive it overhead.",
        ...
        "Nordic Bench Curl": "Keep your body straight from knees to shoulders, lower as slowly as you can, then catch and press back.",
        ...
        "Heavy Bag Rounds": "Punch with straight wrists, exhale on every hit, and bring your hands right back up.",
        ...
        // Catalog expansion (2026-07-31)
        // Calisthenics progressions + skills
        "Pistol Squat": "Arms and free leg forward, sit slowly onto one leg, drive the heel to stand.",
        "Cossack Squat": "Step wide, sink over one heel with the other leg straight, chest tall.",
        "Incline Push-Up": "Hands on the raised edge, body one straight line, chest to the edge.",
        "Knee Push-Up": "Knees down, hips in line with your shoulders, chest to the floor.",
        "Inverted Row": "Hang under the bar, body rigid, pull your chest to it.",
        "Dead Hang": "Full grip, shoulders relaxed but not slack, breathe and hang.",
        "Scapular Pull-Up": "Arms stay straight: lift by pulling the shoulder blades down and together.",
        "Wall Handstand Hold": "Kick up close to the wall, press tall through the shoulders, squeeze everything.",
        "Handstand Push-Up": "Stack hips over shoulders, lower with control, press back to lockout.",
        "Ring Dip": "Steady the rings at lockout first, then lower with the shoulders down.",
        "Ring Muscle-Up": "False grip, pull deep to the chest, lean over the rings through the transition.",
        "Bar Muscle-Up": "Big pull to the sternum, lean over the bar, press away at the top.",
        "Ring Support Hold": "Lock out, turn the rings slightly out, and hold everything tight.",
        "L-Sit": "Press the floor away, legs straight out, shoulders down and locked.",
        "Superman": "Lift arms and legs together, squeeze the glutes, no neck craning.",
        "Bear Crawl": "Knees an inch off the floor, opposite hand and foot, hips quiet.",
        "Broad Jump": "Swing, load the hips, jump far and land soft in a squat.",
        // Olympic lifting
        "Snatch": "Bar close, big hip drive, punch under into the overhead squat.",
        "Clean and Jerk": "Clean to the rack, stand tall, then dip and drive it overhead.",
        "Hang Power Clean": "Start above the knee, hips fire, elbows whip around fast.",
        "Overhead Squat": "Wide grip locked overhead, torso tall, sit between the arms.",
        "Front Rack Lunge": "Elbows high in the rack, long step, knee kisses the floor.",
        "Wall Ball": "Squat deep, drive up, throw to the target and absorb the catch.",
        // Staples
        "Lunge": "Long step forward, both knees to ninety, push back through the front heel.",
        "Barbell Lunge": "Bar set like a squat, long controlled step, drive back through the front heel.",
        "Split Squat": "Feet stay planted in the split, drop straight down, front heel drives.",
        "Lateral Lunge": "Step wide, sit into one hip, the other leg stays straight.",
        "Floor Press": "Upper arms touch the floor each rep, press without bouncing.",
        "Dumbbell Floor Press": "Elbows touch down softly each rep, wrists stacked, press up evenly.",
        "Rack Pull": "Bar at the pins, brace like a deadlift, finish tall with the lats on.",
        "Zercher Squat": "Bar in the crook of the elbows, hands clasped, stay tall as you sit.",
        "Decline Dumbbell Press": "Feet hooked, lower to the low chest, press both bells evenly.",
        "Reverse Curl": "Knuckles up, elbows pinned, curl without swinging.",
        "Wrist Curl": "Forearms on the bench, let the wrists roll down, curl just the hands.",
        "Reverse Wrist Curl": "Palms down on the bench, lift the knuckles, small strict range.",
        "Reverse Crunch": "Lift the hips, curl the knees to your chest, lower slow.",
        "Dumbbell Side Bend": "One bell, slide it down the thigh, pull back up with the far side.",
        "Close-Grip Lat Pulldown": "Chest tall, elbows in front, pull to the collarbone.",
        "Leg Press Calf Raise": "Balls of the feet on the platform edge, full stretch, full squeeze.",
        // Kettlebell depth
        "Kettlebell Press": "Rack the bell, brace, press to lockout with the wrist straight.",
        "Kettlebell Row": "Hinge, flat back, pull the bell to your hip.",
        "Kettlebell Deadlift": "Bell between the feet, hips back, stand tall through the handle.",
        "Kettlebell Front Rack Squat": "Bell racked at the chest, elbows in, sit tall between your heels.",
        "Kettlebell Halo": "Circle the bell close around your head, ribs down, slow and smooth.",
        // Prehab
        "Band External Rotation": "Elbow pinned to your side, rotate the hand out, return slow.",
        "Cable External Rotation": "Elbow at your side, rotate out against the cable, no shrug.",
        "Clamshell": "Side lying, feet together, open the top knee without rolling back.",
        "Copenhagen Plank": "Top foot on the bench, hips in line, squeeze the inner thigh.",
        "YTW Raise": "Chest on the incline, make each letter with thumbs up, squeeze the blades.",
        "Scapular Push-Up": "Arms locked straight, only the shoulder blades pinch and spread.",
        // Conditioning drills + complexes
        "Jumping Jacks": "Land soft, full arm swing, keep a steady rhythm.",
        "High Knees": "Tall posture, knees to hip height, quick light feet.",
        "Butt Kicks": "Heels flick to the glutes, stay tall, quick turnover.",
        "Squat Thrust": "Squat, hands down, shoot the feet back to a plank and snap back in.",
        "Renegade Row": "Push-up position on the bells, feet wide, row without letting the hips twist.",
        "Man Maker": "Push-up, row each side, then clean and press to a full stand.",
        "Devil Press": "Burpee on the bells, then swing them overhead in one drive.",
        "Dumbbell Snatch": "One bell, hips fire, punch it straight overhead.",
        "Dumbbell Clean and Press": "Clean the bells to your shoulders, brace, press to lockout.",
        // Thin-equipment depth
        "Trap Bar Carry": "Deadlift it up, walk tall, quick flat steps.",
        "Trap Bar Shrug": "Stand tall in the bar, shrug straight up, no rolling.",
        "Sandbag Clean": "Hug the bag deep, hips fire, roll it up to your chest.",
        "Sandbag Squat": "Bag high on the chest, squeeze it hard, sit and stand tall.",
        "Sandbag Over Shoulder": "Deep grip under the bag, stand hard, tip it over one shoulder.",
        "Sled Drag": "Lean into the straps, drive the ground away with full steps.",
        "Backward Sled Drag": "Face the sled, sit low, march backward with long quad pushes.",
        "Landmine Squat": "Bar end at the chest, sit back and down, press tall out of the hole.",
        "Landmine Rotation": "Arms long on the bar end, rotate from the hips, feet pivot.",
        "Landmine Romanian Deadlift": "Bar end in both hands, hips back, flat back to the stretch.",
        "Suspension Chest Press": "Lean into the straps, body rigid, press back to the start.",
        "Suspension Pike": "Feet in the straps, hips lift to a pike, control the return.",
        "Suspension Face Pull": "Lean back, pull the handles to your temples, elbows high.",
        "Suspension Hamstring Curl": "Heels in the straps, bridge the hips, curl the heels in.",
        "Battle Rope Slams": "Whole rope overhead, slam through the floor, hips do the work.",
        // Mobility + recovery newcomers
        "Deep Squat Hold": "Sink to the bottom, heels down, elbows pry the knees out, breathe.",
        "Ankle Circles": "One foot up, slow full circles, both directions.",
        "Wrist Circles": "Hands free or clasped, roll through the full range both ways.",
        "Glute Bridge March": "Bridge up, hips level, march one knee up without dropping a side.",
        "90/90 Hip Switch": "Both legs at ninety, swivel the knees side to side, chest tall.",
        "Thread the Needle": "From all fours, slide one arm under and through, follow it with your gaze.",
        "Shoulder Dislocates": "Wide grip on the band, arms straight, over the top and back slow.",
        "Foam Roll Quads": "Front of the thigh on the roller, slow passes, pause on the tender spots.",
        "Foam Roll Hamstrings": "Back of the thigh on the roller, roll slow from knee to hip.",
        "Foam Roll Calves": "Calf on the roller, cross the other leg over for weight, roll slow.",
        "Foam Roll Upper Back": "Roller at mid back, hands behind your head, small slow passes.",
        "Foam Roll Lats": "Side lying, roller under the armpit, roll the outer back slowly.",
        "Foam Roll IT Band": "Side lying on the outer thigh, slow short passes, ease the pressure as needed.",
    ]
}
