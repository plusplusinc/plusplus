...
**Last updated:** 2026-08-05 · **Latest TestFlight build:** 189, from `claude/search-scopes-control-replace-2z9m5x` (#553, native search scopes · the field at the top · the bar yielding on focus · glass filter chips) — NOT main, and deliberately so: each is device-passed BEFORE it lands. ⚠️ 170–185 came from parallel sessions and were never recorded here (this line said 169 for three days); 185 was main at `5e94130`, 181–184 feature branches. Read `actions_list`, never this line, for the CURRENT number.
