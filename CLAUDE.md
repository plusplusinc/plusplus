...
**Last updated:** 2026-08-02 · **Latest TestFlight build:** 170, from `claude/tabview-floating-search-krhbnz` (the floating search key, #543) — NOT main, and NOT merged: Dave asked for the build on the branch so the keyboard-rise question gets answered on device before this lands. 169 was main (the decision-sheet run, #503–#509). ⚠️ 165–168 came off `claude/search-input-animation-bug-fdmdq5`, also not main; 164 and 160–163 were.
...
**docs/DEVICE-PASS.md** (24 items) — one line each, newest first, with the
