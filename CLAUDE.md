...
- Today's header band (QUICK START keys · tally · bar) is PINNED CHROME — a top safeAreaInset, NOT scroll content (reverses the 2026-07-27 sticky law; the visualEffect/reservation machinery is deleted), keys IMPERATIVE (`QuickStartLabel`) with overflow collapsing to an "N more" Menu, never a horizontal scroll; ⚠️ device pass: the PULL (build 152's title-over-band ghost, accepted knowingly — fallback is the 8b9e16b sticky band), plus "Spin"/"Swim open water" (Dave ×5)
